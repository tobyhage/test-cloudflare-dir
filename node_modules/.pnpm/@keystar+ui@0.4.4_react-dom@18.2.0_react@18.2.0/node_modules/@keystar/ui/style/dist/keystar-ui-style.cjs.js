...
const classNamePrefix = primitives.TOKEN_PREFIX;
...
class ClassList {
  ...
  element(name) {
    ...
    emery.assert(!!className, `Element "${name}" not found in "${this.#componentName}" class list. All elements must be defined when the ClassList is instantiated.`);
    return className;
  }
