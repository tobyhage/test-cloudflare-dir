    ...
    children: /*#__PURE__*/jsxRuntime.jsxs("svg", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx("circle", {
        ...
        className: circle({
          ...
          '&[data-indeterminate]': {
            animation: `${indeterminateAnimation} ${style.tokenSchema.animation.duration.xlong} ${style.tokenSchema.animation.easing.easeInOut} infinite`
          }
        }),
        style: {
...
const indeterminateAnimation = style.keyframes({
  from: {
