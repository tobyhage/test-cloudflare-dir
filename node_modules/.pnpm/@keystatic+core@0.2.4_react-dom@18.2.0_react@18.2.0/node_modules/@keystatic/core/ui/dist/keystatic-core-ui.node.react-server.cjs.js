...
var index = require('../../dist/index-dc04e9a4.node.react-server.cjs.js');
...
var requiredFiles = require('../../dist/required-files-2005eba7.node.react-server.cjs.js');
...
function ObjectFieldInput({
  ...
  const inner = /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
    gap: "xlarge",
    direction: "column",
    children: Object.entries(fields).map(([key, propVal]) => /*#__PURE__*/jsxRuntime.jsx(AddToPathProvider, {
      part: key,
