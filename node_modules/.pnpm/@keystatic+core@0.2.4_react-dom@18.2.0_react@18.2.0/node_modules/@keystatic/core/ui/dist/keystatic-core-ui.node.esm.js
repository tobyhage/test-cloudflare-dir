...
import { Flex, Grid, Box, Divider, VStack } from '@keystar/ui/layout';
...
import { useMediaQuery, breakpointQueries, css, tokenSchema, useIsMobileDevice, injectGlobal, containerQueries, classNames, transition } from '@keystar/ui/style';
import { TableView, TableHeader, Column, TableBody, Row, Cell } from '@keystar/ui/table';
import { assert } from 'emery';
import { l as localizedMessages } from '../../dist/languages-0656947a.node.esm.js';
import { u as useRouter, P as PageRoot, a as PageHeader, b as useTree, g as getCollectionPath, i as isLocalConfig, c as getEntriesInCollectionWithTreeKey, B as BranchInfoContext, d as useConfig, e as getBranchPrefix, f as useRepositoryId, R as Ref_base, p as parseRepoConfig, s as serializeRepoConfig, h as getAuth, G as GitHubAppShellQuery, j as getEntryDataFilepath, o as object, k as parseProps, t as toFormattedFormDataError, l as useBaseCommit, m as useIsRepoPrivate, n as useBranchInfo, q as getDirectoriesForTreeKey, r as getTreeKey, v as useData, L as LOADING, w as getTreeNodeAtPath, x as isGitHubConfig, y as blobSha, z as getPathPrefix, K as KEYSTATIC_CLOUD_API_URL, A as KEYSTATIC_CLOUD_HEADERS, C as getSyncAuth, D as redirectToCloudAuth, E as CloudAppShellQuery, F as useSetTreeSha, H as RepoWithWriteAccessContext, I as useCurrentUnscopedTree, J as updateTreeWithChanges, M as hydrateTreeCacheWithEntries, N as scopeEntriesWithPathPrefix, O as fetchGitHubTreeData, Q as treeSha, S as serializeProps, T as getSlugFromState, U as getSlugGlobForCollection, V as getCollectionFormat, W as getCollectionItemPath, X as PageBody, Y as containerWidthForEntryLayout, Z as createGetPreviewProps, _ as useEventCallback, $ as getRepoUrl, a0 as getDataFileExtension, a1 as clientSideValidateProp, a2 as FormForEntry, a3 as getInitialPropsValue, a4 as useNavItems, a5 as pluralize, a6 as useViewer, a7 as useCloudInfo, a8 as isCloudConfig, a9 as useImageLibraryURL, aa as useRawCloudInfo, ab as useAppState, ac as useBrand, ad as GitHubAppShellDataContext, ae as useSidebar, af as useContentPanelState, ag as ContentPanelProvider, ah as SidebarDialog, ai as SidebarPanel, aj as AppShellErrorContext, ak as ConfigContext, al as AppStateContext, am as SidebarProvider, an as GitHubAppShellProvider, ao as LocalAppShellProvider, ap as getSingletonFormat, aq as getSingletonPath, ar as assertValidRepoConfig, as as RouterProvider, at as CloudInfoProvider, au as GitHubAppShellDataProvider } from '../../dist/cloud-image-preview-a5b4b746.node.esm.js';
...
import { Combobox, comboboxClassList, Item } from '@keystar/ui/combobox';
import 'minimatch';
...
import { ActionGroup, Item as Item$3 } from '@keystar/ui/action-group';
...
import { useMutation, useClient, Provider as Provider$1, createClient, fetchExchange } from 'urql';
...
import { u as useSlugsInCollection } from '../../dist/useSlugsInCollection-f9b8d660.node.esm.js';
import { z } from 'zod';
...
function CloudHeader() {
  ...
  return /*#__PURE__*/jsxs(HeaderOuter, {
    children: [/*#__PURE__*/jsx(BrandButton, {}), /*#__PURE__*/jsx(BranchPicker, {}), /*#__PURE__*/jsx(GitMenu, {}), /*#__PURE__*/jsx(Box, {
      flex: "1"
    }), /*#__PURE__*/jsx(ImageLibraryButton, {}), /*#__PURE__*/jsx(ThemeMenu, {}), /*#__PURE__*/jsx(UserMenu, {
      user: cloudInfo ? {
...
function LocalHeader() {
  ...
  const router = useRouter();
  return /*#__PURE__*/jsxs(HeaderOuter, {
    children: [/*#__PURE__*/jsx(BrandButton, {}), /*#__PURE__*/jsx(Box, {
      flex: "1"
    }), /*#__PURE__*/jsx(ImageLibraryButton, {}), /*#__PURE__*/jsx(ThemeMenu, {}), rawCloudInfo ? rawCloudInfo === 'unauthorized' ? /*#__PURE__*/jsx(ActionButton, {
      onPress: () => {
