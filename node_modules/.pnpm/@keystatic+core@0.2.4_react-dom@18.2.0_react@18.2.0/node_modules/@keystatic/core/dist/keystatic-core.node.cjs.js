...
var cloudImagePreview = require('./cloud-image-preview-90810d2c.node.cjs.js');
var api = require('./api-168cac52.node.cjs.js');
...
var useSlugsInCollection = require('./useSlugsInCollection-66f6a184.node.cjs.js');
var picker = require('@keystar/ui/picker');
var slugify = require('@sindresorhus/slugify');
var languages = require('./languages-dac857b5.node.cjs.js');
require('emery');
...
function checkbox({
  ...
  return cloudImagePreview.basicFormFieldWithSimpleReaderParse({
    Input(props) {
    ...
    parse(value) {
      ...
      if (typeof value !== 'boolean') {
        throw new cloudImagePreview.FieldDataError('Must be a boolean');
      }
      return value;
    },
    validate(value) {
  ...
  return cloudImagePreview.basicFormFieldWithSimpleReaderParse({
    ...
    parse(value) {
      ...
      if (typeof value !== 'string') {
        throw new cloudImagePreview.FieldDataError('Must be a string');
      }
      return value;
    },
    serialize(value) {
    ...
    validate(value) {
      ...
      if (message !== undefined) {
        throw new cloudImagePreview.FieldDataError(message);
      }
      cloudImagePreview.assertRequired(value, validation, label);
      return value;
    }
  });
}
...
function image({
  ...
  return {
    ...
    formKind: 'asset',
    Input(props) {
      return /*#__PURE__*/jsxRuntime.jsx(cloudImagePreview.ImageFieldInput, {
        label: label,
        description: description,
        validation: validation,
        ...props
    ...
    filename(value, args) {
      if (typeof value === 'string') {
        return value.slice(cloudImagePreview.getSrcPrefix(publicPath, args.slug).length);
      }
      return undefined;
    },
    parse(value, args) {
      ...
      return {
        data: args.asset,
        filename: value.slice(cloudImagePreview.getSrcPrefix(publicPath, args.slug).length),
    ...
    serialize(value, args) {
      ...
      return {
        value: `${cloudImagePreview.getSrcPrefix(publicPath, args.slug)}${filename}`,
        asset: {
          filename,
          content: value.data
        }
    ...
    directory: directory ? cloudImagePreview.fixPath(directory) : undefined,
    reader: {
      parse(value) {
        ...
        cloudImagePreview.assertRequired(val, validation, label);
        return val;
      }
    }
  };
...
function FileFieldInput(props) {
  ...
  const [blurred, onBlur] = React.useReducer(() => true, false);
  const isInEditor = cloudImagePreview.useIsInDocumentEditor();
  const objectUrl = cloudImagePreview.useObjectURL(value === null ? null : value.data);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(field.FieldLabel, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(button.ActionButton, {
        onPress: async () => {
          const file = await cloudImagePreview.getUploadedFile('');
          if (file) {
...
function multiselect({
  ...
  const field = cloudImagePreview.basicFormFieldWithSimpleReaderParse({
    Input(props) {
    ...
    parse(value) {
      ...
      if (!Array.isArray(value)) {
        throw new cloudImagePreview.FieldDataError('Must be an array of options');
      }
      if (!value.every(x => typeof x === 'string' && valuesToOption.has(x))) {
        throw new cloudImagePreview.FieldDataError(`Must be an array with one of ${options.map(x => x.value).join(', ')}`);
      }
      return value;
    },
    validate(value) {
  ...
  const field = cloudImagePreview.basicFormFieldWithSimpleReaderParse({
    ...
    parse(value) {
      ...
      if (!optionValuesSet.has(value)) {
        throw new cloudImagePreview.FieldDataError('Must be a valid option');
      }
      return value;
    },
    validate(value) {
...
function SlugFieldInput(props) {
  ...
  const slugContext = React.useContext(cloudImagePreview.SlugFieldContext);
  const path = React.useContext(cloudImagePreview.PathContext);
  ...
  const slugErrorMessage = props.forceValidation || blurredSlug ? cloudImagePreview.validateText(props.value.slug, (_props$args$slug$vali = (_props$args$slug = props.args.slug) === null || _props$args$slug === void 0 || (_props$args$slug = _props$args$slug.validation) === null || _props$args$slug === void 0 || (_props$args$slug = _props$args$slug.length) === null || _props$args$slug === void 0 ? void 0 : _props$args$slug.min) !== null && _props$args$slug$vali !== void 0 ? _props$args$slug$vali : 1, (_props$args$slug$vali2 = (_props$args$slug2 = props.args.slug) === null || _props$args$slug2 === void 0 || (_props$args$slug2 = _props$args$slug2.validation) === null || _props$args$slug2 === void 0 || (_props$args$slug2 = _props$args$slug2.length) === null || _props$args$slug2 === void 0 ? void 0 : _props$args$slug2.max) !== null && _props$args$slug$vali2 !== void 0 ? _props$args$slug$vali2 : Infinity, (_props$args$slug$labe = (_props$args$slug3 = props.args.slug) === null || _props$args$slug3 === void 0 ? void 0 : _props$args$slug3.label) !== null && _props$args$slug$labe !== void 0 ? _props$args$slug$labe : 'Slug', slugInfo) : undefined;
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
    gap: "xlarge",
    direction: "column",
    children: [/*#__PURE__*/jsxRuntime.jsx(textField.TextField, {
      ...
      errorMessage: props.forceValidation || blurredName ? cloudImagePreview.validateText(props.value.name, (_props$args$name$vali = (_props$args$name$vali2 = props.args.name.validation) === null || _props$args$name$vali2 === void 0 || (_props$args$name$vali2 = _props$args$name$vali2.length) === null || _props$args$name$vali2 === void 0 ? void 0 : _props$args$name$vali2.min) !== null && _props$args$name$vali !== void 0 ? _props$args$name$vali : 0, (_props$args$name$vali3 = (_props$args$name$vali4 = props.args.name.validation) === null || _props$args$name$vali4 === void 0 || (_props$args$name$vali4 = _props$args$name$vali4.length) === null || _props$args$name$vali4 === void 0 ? void 0 : _props$args$name$vali4.max) !== null && _props$args$name$vali3 !== void 0 ? _props$args$name$vali3 : Infinity, props.args.name.label, undefined) : undefined
...
function parseSlugFieldAsNormalField(value) {
  ...
  if (typeof value !== 'object') {
    throw new cloudImagePreview.FieldDataError('Must be an object');
  }
  if (Object.keys(value).length !== 2) {
    throw new cloudImagePreview.FieldDataError('Unexpected keys');
  }
  if (!('name' in value) || !('slug' in value)) {
    throw new cloudImagePreview.FieldDataError('Missing name or slug');
  }
  if (typeof value.name !== 'string') {
    throw new cloudImagePreview.FieldDataError('name must be a string');
  }
  if (typeof value.slug !== 'string') {
    throw new cloudImagePreview.FieldDataError('slug must be a string');
  }
  return {
    name: value.name,
    slug: value.slug
...
function slug(args) {
  ...
  function validate(value, {
    ...
    const nameMessage = cloudImagePreview.validateText(value.name, (_args$name$validation = (_args$name$validation2 = args.name.validation) === null || _args$name$validation2 === void 0 || (_args$name$validation2 = _args$name$validation2.length) === null || _args$name$validation2 === void 0 ? void 0 : _args$name$validation2.min) !== null && _args$name$validation !== void 0 ? _args$name$validation : 0, (_args$name$validation3 = (_args$name$validation4 = args.name.validation) === null || _args$name$validation4 === void 0 || (_args$name$validation4 = _args$name$validation4.length) === null || _args$name$validation4 === void 0 ? void 0 : _args$name$validation4.max) !== null && _args$name$validation3 !== void 0 ? _args$name$validation3 : Infinity, args.name.label, undefined);
    if (nameMessage !== undefined) {
      throw new cloudImagePreview.FieldDataError(nameMessage);
    }
    const slugMessage = cloudImagePreview.validateText(value.slug, (_args$slug$validation = (_args$slug2 = args.slug) === null || _args$slug2 === void 0 || (_args$slug2 = _args$slug2.validation) === null || _args$slug2 === void 0 || (_args$slug2 = _args$slug2.length) === null || _args$slug2 === void 0 ? void 0 : _args$slug2.min) !== null && _args$slug$validation !== void 0 ? _args$slug$validation : 1, (_args$slug$validation2 = (_args$slug3 = args.slug) === null || _args$slug3 === void 0 || (_args$slug3 = _args$slug3.validation) === null || _args$slug3 === void 0 || (_args$slug3 = _args$slug3.length) === null || _args$slug3 === void 0 ? void 0 : _args$slug3.max) !== null && _args$slug$validation2 !== void 0 ? _args$slug$validation2 : Infinity, (_args$slug$label = (_args$slug4 = args.slug) === null || _args$slug4 === void 0 ? void 0 : _args$slug4.label) !== null && _args$slug$label !== void 0 ? _args$slug$label : 'Slug', slugField ? slugField : {
      slugs: emptySet,
      glob: '*'
    });
    if (slugMessage !== undefined) {
      throw new cloudImagePreview.FieldDataError(slugMessage);
    }
    return value;
  }
  const emptySet = new Set();
...
function BlocksFieldInput(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(layout.Flex, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(button.ActionButton, {
        ...
        onAction: key => {
          ...
          setModalState({
            ...
            initial: {
              discriminant,
              value: cloudImagePreview.getInitialPropsValue(props.schema.element.values[`${discriminant}`])
            }
          });
        },
        children: item => /*#__PURE__*/jsxRuntime.jsx(collections.Item, {
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(cloudImagePreview.ArrayFieldListView, {
      ...props,
      labelId: labelId,
      onOpenItem: idx => {
        setModalState({
          kind: 'edit',
          idx,
          initial: cloudImagePreview.previewPropsToValue(props.elements[idx])
        });
      }
    }), /*#__PURE__*/jsxRuntime.jsx(cloudImagePreview.ArrayFieldValidationMessages, {
      ...props
              ...
              onSubmit: val => {
                ...
                if (modalState.kind === 'new') {
                  props.onChange([...props.elements.map(x => ({
                    ...
                    key: undefined,
                    value: cloudImagePreview.valueToUpdater({
                      value: val,
                      discriminant
                ...
                cloudImagePreview.setValueToPreviewProps(val, props.elements[modalState.idx].value);
              }
            })
          }), /*#__PURE__*/jsxRuntime.jsxs(button.ButtonGroup, {
...
function ItemForm(props) {
  ...
  const previewProps = React.useMemo(() => cloudImagePreview.createGetPreviewProps(props.schema, setValue, () => undefined), [props.schema, setValue])(value);
  const {
    dismiss
  ...
  return /*#__PURE__*/jsxRuntime.jsx(layout.Flex, {
    ...
    onSubmit: event => {
      ...
      if (!cloudImagePreview.clientSideValidateProp(props.schema, value, undefined)) {
    ...
    direction: "column",
    gap: "xxlarge",
    children: /*#__PURE__*/jsxRuntime.jsx(cloudImagePreview.FormValueContentFromPreviewProps, {
...
function ImageField(props) {
  ...
  const onPaste = event => {
    ...
    const parsed = cloudImagePreview.parseImageData(text);
    props.onChange(parsed);
  };
  const onLoad = cloudImagePreview.useEventCallback(data => {
    onChange(data);
    setStatus('good');
  });
  ...
  React.useEffect(() => {
    ...
    if (!languages.isValidURL(props.image.src)) {
      return;
    }
    if (hasSetFields) {
      setStatus('good');
    ...
    setStatus('loading');
    cloudImagePreview.loadImageData(props.image.src, config).then(newData => {
      onLoad(newData);
    }).catch(() => {
      setStatus('error');
    });
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(textField.TextField, {
      ...
      onKeyDown: e => {
        if (e.code === 'Backspace' || e.code === 'Delete') {
          props.onChange(cloudImagePreview.emptyImageData);
        }
      },
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(cloudImagePreview.ImageDimensionsInput, {
        src: image.src,
        image: image,
        onChange: dimensions => {
          onChange({
...
function cloudImage({
  ...
  return {
    ...cloudImagePreview.object({
      src: cloudImagePreview.text({
        label: 'URL',
        validation: {
          length: {
...
var index = /*#__PURE__*/Object.freeze({
  ...
  date: date,
  datetime: datetime,
  document: cloudImagePreview.document,
  ...
  object: cloudImagePreview.object,
  pathReference: pathReference,
  relationship: relationship,
  select: select,
  slug: slug,
  text: cloudImagePreview.text,
  url: url,
  blocks: blocks,
  cloudImage: cloudImage
});

exports.BlockWrapper = cloudImagePreview.BlockWrapper;
exports.NotEditable = cloudImagePreview.NotEditable;
exports.ToolbarSeparator = cloudImagePreview.ToolbarSeparator;
exports.collection = cloudImagePreview.collection;
exports.config = cloudImagePreview.config;
exports.singleton = cloudImagePreview.singleton;
