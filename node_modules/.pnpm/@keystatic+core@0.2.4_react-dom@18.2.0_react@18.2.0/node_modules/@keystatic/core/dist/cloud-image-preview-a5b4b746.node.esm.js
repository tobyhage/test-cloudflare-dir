...
import React, { useState, useMemo, useEffect, useContext, createContext, startTransition, useCallback, useRef, useId, cloneElement, forwardRef, Fragment as Fragment$1, useReducer, createElement, memo } from 'react';
import { TextArea, TextField } from '@keystar/ui/text-field';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { FieldMessage, FieldLabel, Field } from '@keystar/ui/field';
import { Box, Flex, Divider, Grid, VStack, HStack } from '@keystar/ui/layout';
...
import { ActionButton, ButtonGroup, Button, ToggleButton, ClearButton } from '@keystar/ui/button';
import { DialogContainer, Dialog, useDialogContainer, DialogTrigger } from '@keystar/ui/dialog';
...
import { l as localizedMessages, i as isValidURL$1, a as aliasesToLabel, b as aliasesToCanonicalName, c as canonicalNameToLabel, d as labelToCanonicalName, e as languagesWithAliases, P as Prism } from './languages-0656947a.node.esm.js';
import { ReactEditor, useSlate, useSlateStatic, useSelected, Slate, Editable, withReact } from 'slate-react';
import isHotkey from 'is-hotkey';
import { css, breakpoints, useMediaQuery, useBreakpoint, tokenSchema, transition, toDataAttributes, breakpointQueries, classNames } from '@keystar/ui/style';
...
import { usePrevious as usePrevious$1, useId as useId$1 } from '@keystar/ui/utils';
...
function ObjectFieldInput({
  ...
  const inner = /*#__PURE__*/jsx(Flex, {
    gap: "xlarge",
    direction: "column",
    children: Object.entries(fields).map(([key, propVal]) => /*#__PURE__*/jsx(AddToPathProvider, {
      part: key,
...
function withPasting(editor) {
  ...
  editor.insertTextData = data => {
    ...
    urlPattern.test(plain) && isValidURL$1(plain) && editor.selection && !Range.isCollapsed(editor.selection) &&
...
export { getRepoUrl as $, KEYSTATIC_CLOUD_HEADERS as A, BranchInfoContext as B, getSyncAuth as C, redirectToCloudAuth as D, CloudAppShellQuery as E, useSetTreeSha as F, GitHubAppShellQuery as G, RepoWithWriteAccessContext as H, useCurrentUnscopedTree as I, updateTreeWithChanges as J, KEYSTATIC_CLOUD_API_URL as K, LOADING as L, hydrateTreeCacheWithEntries as M, scopeEntriesWithPathPrefix as N, fetchGitHubTreeData as O, PageRoot as P, treeSha as Q, Ref_base as R, serializeProps as S, getSlugFromState as T, getSlugGlobForCollection as U, getCollectionFormat as V, getCollectionItemPath as W, PageBody as X, containerWidthForEntryLayout as Y, createGetPreviewProps as Z, useEventCallback as _, PageHeader as a, formatFormDataError as a$, getDataFileExtension as a0, clientSideValidateProp as a1, FormForEntry as a2, getInitialPropsValue as a3, useNavItems as a4, pluralize as a5, useViewer as a6, useCloudInfo as a7, isCloudConfig as a8, useImageLibraryURL as a9, singleton as aA, BlockWrapper as aB, NotEditable as aC, ToolbarSeparator as aD, ImageFieldInput as aE, getSrcPrefix as aF, fixPath as aG, useIsInDocumentEditor as aH, useObjectURL as aI, getUploadedFile as aJ, SlugFieldContext as aK, PathContext as aL, validateText as aM, ArrayFieldListView as aN, previewPropsToValue as aO, ArrayFieldValidationMessages as aP, valueToUpdater as aQ, setValueToPreviewProps as aR, FormValueContentFromPreviewProps as aS, loadImageData as aT, emptyImageData as aU, ImageDimensionsInput as aV, parseImageData as aW, text as aX, document$1 as aY, sha1 as aZ, getValueAtPropPath as a_, useRawCloudInfo as aa, useAppState as ab, useBrand as ac, GitHubAppShellDataContext as ad, useSidebar as ae, useContentPanelState as af, ContentPanelProvider as ag, SidebarDialog as ah, SidebarPanel as ai, AppShellErrorContext as aj, ConfigContext as ak, AppStateContext as al, SidebarProvider as am, GitHubAppShellProvider as an, LocalAppShellProvider as ao, getSingletonFormat as ap, getSingletonPath as aq, assertValidRepoConfig as ar, RouterProvider as as, CloudInfoProvider as at, GitHubAppShellDataProvider as au, basicFormFieldWithSimpleReaderParse as av, FieldDataError as aw, assertRequired as ax, config as ay, collection as az, useTree as b, treeEntriesToTreeNodes as b0, CloudImagePreview as b1, cloudImageToolbarIcon as b2, getEntriesInCollectionWithTreeKey as c, useConfig as d, getBranchPrefix as e, useRepositoryId as f, getCollectionPath as g, getAuth as h, isLocalConfig as i, getEntryDataFilepath as j, parseProps as k, useBaseCommit as l, useIsRepoPrivate as m, useBranchInfo as n, object as o, parseRepoConfig as p, getDirectoriesForTreeKey as q, getTreeKey as r, serializeRepoConfig as s, toFormattedFormDataError as t, useRouter as u, useData as v, getTreeNodeAtPath as w, isGitHubConfig as x, blobSha as y, getPathPrefix as z };
