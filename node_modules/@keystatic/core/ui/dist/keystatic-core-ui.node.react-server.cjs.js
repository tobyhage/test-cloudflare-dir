...
var index = require('../../dist/index-1b704b17.node.react-server.cjs.js');
...
var isValidURL = require('../../dist/isValidURL-fed5db70.node.react-server.cjs.js');
...
var requiredFiles = require('../../dist/required-files-d6e3e935.node.react-server.cjs.js');
...
const storedValSchema$2 = z.z.object({
...
function CreateItem(props) {
  ...
  const [state, setState] = React.useState((_props$draft$state = (_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft.state) !== null && _props$draft$state !== void 0 ? _props$draft$state : initialState);
  React.useEffect(() => {
  ...
  const basePath = index.getCollectionItemPath(props.config, props.collection, slug);
